...
public class ScreenPlayer implements Runnable {
	...
	private JPEGFrameDecompressor decompressor;
	...
	private void initialize() {
		...
		try {
			...
			decompressor = new JPEGFrameDecompressor(iStream, width, height);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	private void readFrame() throws IOException {
		...
		JPEGFrameDecompressor.FramePacket frame = decompressor.unpack();
